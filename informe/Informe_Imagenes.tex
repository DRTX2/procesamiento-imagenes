...
\fancyhead[L]{}
\fancyhead[R]{}
\fancyhead[C]{\includegraphics[height=1.5cm]{picture/logo.pdf}}
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{Efecto del umbral de binarización sobre la imagen W51 comprimida (bloque $2\times2$, media = 57.9). Con $T$ bajo se clasifica como blanco una mayor proporción de píxeles; con $T=128$ (superior a la media) la selección se restringe a las zonas de mayor intensidad, correspondientes al gas ionizado y las estrellas más brillantes.}
